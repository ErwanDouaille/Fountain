#include "SynchroDualRightObserver.h"

SynchroDualRightObserver::SynchroDualRightObserver(void) : Observer("SynchroDualRightObserver")
{
}

SynchroDualRightObserver::~SynchroDualRightObserver(void)
{
}

Node* SynchroDualRightObserver::clone(string cloneName) const
{
	return new SynchroDualRightObserver();
}

bool SynchroDualRightObserver::start()
{
	cout << "Start Observer" << endl;
	return true;
}

bool SynchroDualRightObserver::stop()
{
	cout << "Stop Observer" << endl;
	return true;
}

void SynchroDualRightObserver::synchroDualUp(string idFirst, Point3D positionFirst, string idSecond, Point3D positionSecond)
{
...
bool SynchroDualRightObserver::observe(map<string,Group3D*> g3D,map<string,Group2D*>,map<string,Group1D*>, map<string,GroupSwitch*>)
{
...
set<string> SynchroDualRightObserver::need() const
{
	set<string> needed;
